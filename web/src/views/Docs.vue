            ...
            <div class="doc-content">
              ...
              <div id="quick-start" class="doc-section">
                ...
                <div class="code-block">
                  <pre><code>go get github.com/clarkzhu2020/aidecms</code></pre>
                </div>
...
go get github.com/clarkzhu2020/aidecms</code></pre>
                </div>
...
func main() {
    ...
    app.Run()
              ...
              <div id="ai-integration" class="doc-section">
                ...
                <h3>使用示例</h3>
                <div class="code-block">
                  <pre><code>import "github.com/clarkzhu2020/aidecms/pkg/ai"
...
for chunk := range stream {
    fmt.Print(chunk)
              ...
              <div id="web3-integration" class="doc-section">
                ...
                <h3>使用示例</h3>
                <div class="code-block">
                  <pre><code>import "github.com/clarkzhu2020/aidecms/pkg/web3"
...
for exchange, price := range prices {
    fmt.Printf("%s: $%s\n", exchange, price)
              ...
              <div id="task-schedule" class="doc-section">
                ...
                <h3>使用示例</h3>
                <div class="code-block">
                  <pre><code>import "github.com/clarkzhu2020/aidecms/pkg/schedule"
...
scheduler.NewTask("custom").Cron("0 */2 * * *").Do(func() error {
    return customJob()
              ...
              <div id="queue-system" class="doc-section">
                ...
                <h3>使用示例</h3>
                <div class="code-block">
                  <pre><code>import "github.com/clarkzhu2020/aidecms/pkg/queue"
