...
```bash
# 克隆项目
git clone https://github.com/clarkzhu2020/aidecms.git
cd clarkgo
...
如果发现 Bug 或有功能建议，请[创建 Issue](https://github.com/clarkzhu2020/aidecms/issues)。
...
- 项目地址: [https://github.com/clarkzhu2020/aidecms](https://github.com/clarkzhu2020/aidecms)
