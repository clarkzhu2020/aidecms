    ...
    <div class="container">
      <div class="nav-content">
        ...
        <div class="nav-links" :class="{ 'mobile-open': mobileMenuOpen }">
          ...
          <router-link to="/customer-service-demo" @click="mobileMenuOpen = false" class="customer-service-link">
            💬 智能客服
          </router-link>
          <a href="https://github.com/clarkzhu2020/aidecms" target="_blank" class="btn-primary">
